package com.smart.videored.middleware.hw.photomovie.record;
    ...
    public void startRecordImpl(final OnRecordListener listener) throws IOException {
        ...
        try {
            while (true) {
                ...
                MLog.i(TAG, "com.lubuteam.storymaker.libs.hw.photomovie.record frame " + frameCount);
                MLog.i(TAG, "com.lubuteam.storymaker.libs.hw.photomovie.record 耗时 " + (e - s) + "ms" + " 绘制耗时:" + (e1 - s1) + "ms");
                frameCount++;
