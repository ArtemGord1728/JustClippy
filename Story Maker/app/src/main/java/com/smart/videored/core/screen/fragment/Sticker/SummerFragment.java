...
public class SummerFragment extends Fragment implements StickerAdapter.StickerAdaperListener {
    ...
    public ArrayList<Sample> Light() {
        ...
        arrayList.add(new Sample(R.drawable.sum01));
        arrayList.add(new Sample(R.drawable.sum02));
        arrayList.add(new Sample(R.drawable.sum03));
        arrayList.add(new Sample(R.drawable.sum04));
        arrayList.add(new Sample(R.drawable.sum05));
        arrayList.add(new Sample(R.drawable.sum06));
        arrayList.add(new Sample(R.drawable.sum07));
        arrayList.add(new Sample(R.drawable.sum08));
        arrayList.add(new Sample(R.drawable.sum09));
        arrayList.add(new Sample(R.drawable.sum10));
        arrayList.add(new Sample(R.drawable.sum11));
        arrayList.add(new Sample(R.drawable.sum12));
        arrayList.add(new Sample(R.drawable.sum13));
        arrayList.add(new Sample(R.drawable.sum14));
        return arrayList;
    }
