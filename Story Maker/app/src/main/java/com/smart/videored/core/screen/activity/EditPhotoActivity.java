package com.smart.videored.core.screen.activity;
...
import com.smart.videored.core.adapter.ColorAdapter;
import com.smart.videored.core.listener.ColorFragmentListener;
import com.smart.videored.core.listener.FontFragmentListener;
import com.smart.videored.core.listener.FormatTextFragmentListener;
import com.smart.videored.core.listener.HightLightFragmentListener;
import com.smart.videored.core.listener.OverlayListener;
import com.smart.videored.core.listener.ShadowFragmentListener;
import com.smart.videored.core.listener.SpacingFragmentListener;
import com.smart.videored.core.listener.StrokeFragmentListener;
import com.smart.videored.core.listener.eventbus.EditerModel;
import com.smart.videored.core.screen.activity.keyboard.KeyboardHeightObserver;
import com.smart.videored.core.screen.activity.keyboard.KeyboardHeightProvider;
import com.smart.videored.core.screen.dialog.DiscardDialog;
import com.smart.videored.core.screen.fragment.ColorFragment;
import com.smart.videored.core.screen.fragment.EmojiFragment;
import com.smart.videored.core.screen.fragment.OverlaysFragment;
import com.smart.videored.core.screen.fragment.Sticker.StickerFragment;
import com.smart.videored.core.screen.fragment.TuneImage.TuneFragment;
import com.smart.videored.core.screen.fragment.texttools.FontFragment;
import com.smart.videored.core.screen.fragment.texttools.FormatTextFragment;
import com.smart.videored.core.screen.fragment.texttools.HightLightTextFragment;
import com.smart.videored.core.screen.fragment.texttools.SpacingTextFragment;
import com.smart.videored.core.screen.fragment.texttools.StrokeTextFragment;
import com.smart.videored.core.utils.BitmapProcess;
import com.smart.videored.core.utils.ViewAnimation;
import com.smart.videored.core.utils.photoeditor.OnPhotoEditorListener;
import com.smart.videored.core.utils.photoeditor.PhotoEditor;
import com.smart.videored.core.utils.photoeditor.PhotoEditorView;
import com.smart.videored.core.utils.photoeditor.SaveSettings;
import com.smart.videored.core.utils.photoeditor.ViewType;
...
import com.smart.videored.ui.activities.BaseSplitActivity;
import com.smart.videored.utils.ColorFilterGenerator;
import com.smart.videored.view.RoundViewDelegate;
...
public class EditPhotoActivity extends BaseSplitActivity implements View.OnClickListener, OnPhotoEditorListener,
    ...
    private String[] tabs = {"Add text", "Sticker", "Emoji", "Overlays", "Tune"};
    ...
    private void initTextToolsTabbar() {
        ...
        for (int i = 0; i < tabLayoutTextTools.getTabCount(); i++) {
            ...
            if (i == 0)
                tabLayoutTextTools.getTabAt(0).getIcon().setColorFilter(ContextCompat.getColor(EditPhotoActivity.this
    ...
    private void initTabBar() {
        ...
        mViewPagerAdapter.addFragment(tabs[1],
                stickerFragment
        );
        ...
        mViewPagerAdapter.addFragment(tabs[3], overlaysFragment);
    ...
    private void savePhoto() {
        File outputMediaFile = Storage.getOutputFileImage(this);
  ...
  /*  public void onOverplayClick(@NotNull Bitmap bitmap) {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // TODO move to base
    // Show keyboard in Tranlucents Statusbar
    ...
    private final KeyboardHeightObserver currkeyboardHeightObserver = EditPhotoActivity.this::onKeyboardHeightChanged;
    ...
    protected void onKeyboardHeightChanged(int height) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && getHeightStatusBar(this) > 0) {
            rlAddText.setPadding(0, 0, 0, (height));
        }
    }
    ...
    public void onStart() {
        super.onStart();
        addKeyboardHeightObserver(currkeyboardHeightObserver);
    }

    @Override
    public void onStop() {
        super.onStop();
        removeKeyboardHeightObserver(currkeyboardHeightObserver);
    }
    ...
    protected int modifyKeyboardHeight(int height) {
        height += getResources().getDimensionPixelSize(R.dimen._60sdp) / 2;
        if (height < 0) {
            height = 0;
        }
        return height;
