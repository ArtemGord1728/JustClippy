...
public class WomenDayFragment extends Fragment implements StickerAdapter.StickerAdaperListener {
    ...
    public ArrayList<Sample> Light() {
        ...
        arrayList.add(new Sample(R.drawable.ho01));
        arrayList.add(new Sample(R.drawable.ho02));
        arrayList.add(new Sample(R.drawable.ho03));
        arrayList.add(new Sample(R.drawable.ho04));
        return arrayList;
    }
